...
function Product(prod) {
      ...
      <div className="ProductDetailsDiv">
        ...
        <label className="Product_price">Price: {prod.price} $</label>
            ...
            <div className="shoe-desc__actions">
                <button id="my_btn" onClick={(event,prod)=> setButtonPopup(true)}>Description</button>
            </div>
  ...
  <div>
      ...
      <label className="Product_description"><u>Description:</u>&nbsp;{prod.description}</label>
      <br></br>
      <br></br>
      <img src={prod.imgsrc2} alt="" className="ImgProductInfo"></img>
      <br></br>
      <br></br>
      <label className="Product_store"><u>Where to buy :</u>&nbsp;{prod.store}</label>
    </div>
      </Popup>
  </div>
